const RESPONSES = {
  SALUDO: "Hola. Soy el asistente de Cáceres & Casio.\n\nAntes de hablar de una póliza, necesito ubicar qué decisión quieres tomar.\n\n¿Qué situación quieres revisar?",
  PRECIO: "Sí, podemos llegar a un número.\n\nPrimero necesito ubicar el caso:\n¿auto, empresa, flotilla, salud, vida o patrimonio?",
  ...
  EMPRESA_CONTINUACION: "Si viene de contrato, licitación o siniestro, conviene ubicarlo bien.\n\n¿Qué responsabilidad te están pidiendo cubrir?",
  ...
  VIDA: "Cuando alguien depende de tu ingreso, primero hay que entender cuánto tiempo tendría que sostenerse.\n\n¿Hay dependientes, deuda o empresa de por medio?",
  ...
  INFORMACION: "Para ubicarlo mejor, dime qué se parece más a tu situación:\n\nauto, empresa, flotilla, salud, vida o patrimonio.",
  CITA: "Podemos avanzar si primero ubicamos el tema.\n\n¿Sería sobre empresa, salud, vida, auto, patrimonio o contrato?",
  APPOINTMENT_DATA: "Para registrarlo, dime solo dos datos:\ntu nombre y un horario posible.\nPor ejemplo: Franklin, mañana 11:00.",
  ...
  ASEGURADORAS: "La aseguradora importa, pero no es el primer paso.\n\n¿Qué quieres resolver: costo, cobertura, requisito o exclusión?",
  ...
  DESCONOCIDO: "Para ubicarlo mejor, dime qué se parece más a tu situación:\n\nauto, empresa, flotilla, salud, vida o patrimonio.",
};
